...
--http://ptr.wowhead.com/item=71799 needs to be checked before 4.3 goes live.
	...
	AtlasLoot_Data["LeatherItemEnhancement"] = {
		["Normal"] = {
			{
				{ 1, "s85008", "Trade_LeatherWorking", "=ds=Draconic Embossment - Agility", "=ds=#sr# 500", "=ds="..AL["Trainer"] };
				{ 2, "s85010", "Trade_LeatherWorking", "=ds=Draconic Embossment - Intellect", "=ds=#sr# 500", "=ds="..AL["Trainer"] };
				{ 3, "s85007", "Trade_LeatherWorking", "=ds=Draconic Embossment - Stamina", "=ds=#sr# 500", "=ds="..AL["Trainer"] };
				{ 4, "s85009", "Trade_LeatherWorking", "=ds=Draconic Embossment - Strength", "=ds=#sr# 500", "=ds="..AL["Trainer"] };
				{ 5, "s85068", "Trade_LeatherWorking", "=ds=Charscale Leg Reinforcements", "=ds=#sr# 465", "=ds="..AL["Trainer"] };
				{ 6, "s85067", "Trade_LeatherWorking", "=ds=Dragonbone Leg Reinforcements", "=ds=#sr# 465", "=ds="..AL["Trainer"] };
				{ 7, "s101600", "Trade_LeatherWorking", "=ds=Dragonbone Leg Reinforcements", "=ds=#sr# 465", "=ds="..AL["Trainer"] };
				{ 8, "s62448", "44963", "=q4=Earthen Leg Armor", "=ds=#sr# 425", "=ds="..AL["Trainer"] };
				{ 9, "s50965", "38373", "=q4=Frosthide Leg Armor", "=ds=#sr# 425", "=ds="..AL["Trainer"] };
				{ 10, "s50967", "38374", "=q4=Icescale Leg Armor", "=ds=#sr# 425", "=ds="..AL["Trainer"] };
				{ 11, "s50964", "38371", "=q3=Jormungar Leg Armor", "=ds=#sr# 405", "=ds="..AL["Trainer"] };
				{ 12, "s60583", "Trade_LeatherWorking", "=ds=Jormungar Leg Reinforcements", "=ds=#sr# 405", "=ds="..AL["Trainer"] };
				{ 13, "s57683", "Trade_LeatherWorking", "=ds=Fur Lining - Attack Power", "=ds=#sr# 400", "=ds="..AL["Trainer"] };
				{ 14, "s57701", "Trade_LeatherWorking", "=ds=Fur Lining - Arcane Resist", "=ds=#sr# 400", "=ds="..AL["Drop"]..": "..BabbleZone["Icecrown"] };
				{ 15, "s57692", "Trade_LeatherWorking", "=ds=Fur Lining - Fire Resist", "=ds=#sr# 400", "=ds="..AL["Drop"]..": "..BabbleZone["Icecrown"] };
				{ 16, "s57694", "Trade_LeatherWorking", "=ds=Fur Lining - Frost Resist", "=ds=#sr# 400", "=ds="..AL["Drop"]..": "..BabbleZone["Icecrown"] };
				{ 17, "s57699", "Trade_LeatherWorking", "=ds=Fur Lining - Nature Resist", "=ds=#sr# 400", "=ds="..AL["Drop"]..": "..BabbleZone["Icecrown"] };
				{ 18, "s57696", "Trade_LeatherWorking", "=ds=Fur Lining - Shadow Resist", "=ds=#sr# 400", "=ds="..AL["Drop"]..": "..BabbleZone["Icecrown"] };
				{ 19, "s57691", "Trade_LeatherWorking", "=ds=Fur Lining - Spell Power", "=ds=#sr# 400", "=ds="..AL["Trainer"] };
				{ 20, "s57690", "Trade_LeatherWorking", "=ds=Fur Lining - Stamina", "=ds=#sr# 400", "=ds="..AL["Trainer"] };
				{ 21, "s50966", "38372", "=q3=Nerubian Leg Armor", "=ds=#sr# 400", "=ds="..AL["Trainer"] };
				{ 22, "s60584", "Trade_LeatherWorking", "=ds=Nerubian Leg Reinforcements", "=ds=#sr# 400", "=ds="..AL["Trainer"] };
				{ 23, "s50963", "38376", "=q2=Heavy Borean Armor Kit", "=ds=#sr# 395", "=ds="..AL["Trainer"] };
				{ 24, "s35557", "29536", "=q4=Nethercleft Leg Armor", "=ds=#sr# 365", "=ds="..BabbleFaction["Cenarion Expedition"].." - "..BabbleFaction["Exalted"] };
				{
					{ 25, "s35554", "29535", "=q4=Nethercobra Leg Armor", "=ds=#sr# 365", "=ds="..BabbleFaction["Thrallmar"].." - "..BabbleFaction["Exalted"] };
					{ 25, "s35554", "29535", "=q4=Nethercobra Leg Armor", "=ds=#sr# 365", "=ds="..BabbleFaction["Honor Hold"].." - "..BabbleFaction["Exalted"] };
				};
				{ 26, "s44770", "34207", "=q2=Glove Reinforcements", "=ds=#sr# 350", "=ds="..AL["Trainer"] };
				{ 27, "s50962", "38375", "=q1=Borean Armor Kit", "=ds=#sr# 350", "=ds="..AL["Trainer"] };
				{ 28, "s44970", "34330", "=q1=Heavy Knothide Armor Kit", "=ds=#sr# 350", "=ds="..AL["Trainer"] };
				{ 29, "s35524", "29488", "=q2=Arcane Armor Kit", "=ds=#sr# 340", "=ds="..AL["Drop"]..": "..BabbleZone["The Black Morass"] };
				{ 30, "s35521", "29485", "=q2=Flame Armor Kit", "=ds=#sr# 340", "=ds="..AL["Drop"]..": "..BabbleZone["The Arcatraz"] };
			};
			{
				{ 1, "s35522", "29486", "=q2=Frost Armor Kit", "=ds=#sr# 340", "=ds="..AL["Drop"]..": "..BabbleZone["The Steamvault"] };
				{ 2, "s35523", "29487", "=q2=Nature Armor Kit", "=ds=#sr# 340", "=ds="..AL["Drop"]..": "..BabbleZone["The Slave Pens"] };
				{ 3, "s35520", "29483", "=q2=Shadow Armor Kit", "=ds=#sr# 340", "=ds="..AL["Drop"]..": "..BabbleZone["Sethekk Halls"] };
				{ 4, "s35555", "29534", "=q3=Clefthide Leg Armor", "=ds=#sr# 335", "=ds="..BabbleFaction["Cenarion Expedition"].." - "..BabbleFaction["Honored"] };
				{
					{ 5, "s35549", "29533", "=q3=Cobrahide Leg Armor", "=ds=#sr# 335", "=ds="..BabbleFaction["Thrallmar"].." - "..BabbleFaction["Honored"] };
					{ 5, "s35549", "29533", "=q3=Cobrahide Leg Armor", "=ds=#sr# 335", "=ds="..BabbleFaction["Honor Hold"].." - "..BabbleFaction["Honored"] };
				};
				{ 6, "s32458", "25652", "=q1=Magister's Armor Kit", "=ds=#sr# 325", "=ds="..BabbleFaction["The Scryers"].." - "..BabbleFaction["Revered"] };
				{ 7, "s32457", "25651", "=q1=Vindicator's Armor Kit", "=ds=#sr# 325", "=ds="..BabbleFaction["The Aldor"].." - "..BabbleFaction["Revered"] };
				{ 8, "s22727", "18251", "=q3=Core Armor Kit", "=ds=#sr# 300", "=ds="..AL["Drop"]..": "..BabbleZone["Molten Core"] };
				{ 9, "s32456", "25650", "=q1=Knothide Armor Kit", "=ds=#sr# 300", "=ds="..AL["Trainer"] };
				{ 10, "s19058", "15564", "=q1=Rugged Armor Kit", "=ds=#sr# 250", "=ds="..AL["Trainer"] };
				{ 11, "s10487", "8173", "=q1=Thick Armor Kit", "=ds=#sr# 200", "=ds="..AL["Trainer"] };
				{ 12, "s3780", "4265", "=q1=Heavy Armor Kit", "=ds=#sr# 150", "=ds="..AL["Trainer"] };
				{ 13, "s2165", "2313", "=q1=Medium Armor Kit", "=ds=#sr# 100", "=ds="..AL["Trainer"] };
				{ 14, "s2152", "2304", "=q1=Light Armor Kit", "=ds=#sr# 1", "=ds="..AL["Trainer"] };
			};
		};
		info = {
